...
<body>
	<div class="main">
		...
		if(isset($_POST['onum'])){
			...
			$onum = $_POST['onum'];
			$retrieve = mysqli_query($con, "select * from orphans where onum='$onum' and representative='$representative'");
			if(mysqli_num_rows($retrieve) == 0){
				echo "<h4>You either did not register that orphan or the number doesn't exist</h4>";
			}
			else{
